...
function inicializarGraficoInterativo() {
    ...
    // Cria o gráfico com configurações corretas de tamanho
    new Chart(ctx, {
        type: 'bar',
        data: {
        ...
        options: {
            responsive: true,
            maintainAspectRatio: false,  /* ⬅️ ESSENCIAL: permite usar altura do container */
            animation: {
                duration: 1800,
                easing: 'easeOutQuart'
            },
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: function(context) {
                            ...
                            if (label) label += ': ';
                            const unidade = context.dataIndex === 0 ? ' sc/ha' : '%';
                            return label + context.parsed.y + unidade;
                        }
                    }
                },
                title: { display: false }
